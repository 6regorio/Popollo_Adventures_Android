...
public class CargarDatos {
    ...
    public Enemigo cargarPoring() {
        ...
        Enemigo poring = new Enemigo("Poring", 20, 20, 20,
                20, 10, 5, 5, 5, habilidadesPoring,
    ...
    public Enemigo cargarNigromante() {
        ...
        Enemigo nigromante = new Enemigo("Nigromante", 40, 40, 24,
                24, 15, 5, 5, 5, habilidadesNigromante,
    ...
    public Enemigo cargarGolem() {
        ...
        Enemigo golem = new Enemigo("Golem", 60, 60, 20,
                20, 20, 5, 6, 8, habilidadesGolem,
    ...
    public Enemigo cargarGoblin() {
        ...
        Enemigo goblin = new Enemigo("Goblin", 70, 70, 24,
                24, 18, 5, 8, 6, habilidadesGoblin,
    ...
    public Enemigo cargarPulpoi() {
        ...
        Enemigo pulpoi = new Enemigo("Pulpoi", 200, 200, 40,
                40, 40, 5, 15, 15, habilidadesPulpoi,
